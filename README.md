...
<p align="center">
  ...
  检索、记忆、语音、离线音色都在手机上算。我们没有自己的服务器。
</p>
...
- **这一块还在修。** 免按键那条路（它念完自己竖起耳朵听你说下一句）毛病不少，现在只是个雏形，见下面「已知问题与限制」。想稳一点就先按住说话。
...
**语音实时通话还在修。** 免按键那一套——它念完自己听你说下一句——目前 bug 不少：偶尔抢话、偶尔漏听、网络一抖中间就断一截。现在只是个雏形，别拿它当能用的东西。想稳一点就先按住说话。
